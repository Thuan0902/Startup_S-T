                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-4">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="text-center">Dang nhap he thong</p>
                                ...
                                <form method="POST" action="{{ route('login.store') }}">
                                    ...
                                    <a href="{{ route('auth.google') }}" class="btn btn-outline-danger w-100 py-8 fs-4 mb-3 rounded-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">Chua co tai khoan?</p>
                                        <a class="text-primary fw-bold ms-2" href="{{ route('register') }}">Dang ky</a>
                                    </div>
                                </form>
                            </div>
                        </div>
