...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- Sidebar Start -->
        <aside class="left-sidebar" style="margin-top: -5%;">
            <!-- Sidebar scroll-->
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="{{ route('home') }}" aria-expanded="false" class="text-nowrap logo-img">
                        <img src="{{ asset('frontend/Admin/images/logos/logo.svg') }}" alt="" />
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between has-arrow" href="javascript:void(0)" aria-expanded="false">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="hide-menu">Trang web</span>
                                </div>
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between"
                                        href="{{ route('occasion') }}" aria-expanded="false">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="round-16 d-flex align-items-center justify-content-center">
                                                <i class="ti ti-circle"></i>
                                            </div>
                                            <span class="hide-menu">Quản lý dịp</span>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between"
                                        href="{{ route('products') }}" aria-expanded="false">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="round-16 d-flex align-items-center justify-content-center">
                                                <i class="ti ti-circle"></i>
                                            </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between"
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <span class="hide-menu">Quản lý nội dung trang</span>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between"
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <span class="hide-menu">Chưa biết </span>
                                        </div>
                        ...
                        <!-- <li class="nav-small-cap">
                            <iconify-icon icon="solar:menu-dots-linear" class="nav-small-cap-icon fs-4"></iconify-icon>
                            <span class="hide-menu">Ứng Dụng (Phát triển sau)</span>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between has-arrow" href="javascript:void(0)" aria-expanded="false">
                                <div class="d-flex align-items-center gap-3">
        ...
        <div class="body-wrapper" style="margin-top: -5%;">
            <!--  Header Start -->
            <header class="app-header" style="margin-top: -5%;">
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="{{ asset('frontend/Admin/images/profile/user-1.jpg') }}" alt="" width="35" height="35" class="rounded-circle">
                                </a>
    ...
    <script src="{{ asset('frontend/Admin/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
    <script src="{{ asset('frontend/Admin/libs/simplebar/dist/simplebar.js') }}"></script>
    <script src="{{ asset('frontend/Admin/js/dashboard.js') }}"></script>
    <!-- solar icons -->
