...
<main class="main">
    ...
    <div class="page-title light-background">
        <div class="container">
            <h1>{{ $pageContent['page_title'] ?? 'About' }}</h1>
            <nav class="breadcrumbs">
                <ol>
                    <li><a href="{{URL::to('/center')}}">{{ $pageContent['breadcrumb_home'] ?? 'Home' }}</a></li>
                    <li class="current">{{ $pageContent['page_title'] ?? 'About' }}</li>
                </ol>
            </nav>
        </div>
    </div><!-- End Page Title -->
            ...
            <div class="content">
                <div class="row justify-content-center">
                    ...
                    <div class="offset-md-0 offset-lg-1 col-sm-12 col-md-5 col-lg-5 col-xl-4" data-aos="fade-up">
                        <div class="px-3">
                            <span class="content-subtitle">{{ $pageContent['mission_subtitle'] ?? 'Our Mission' }}</span>
                            <h2 class="content-title text-start">
                                {{ $pageContent['mission_title'] ?? 'The Big Oxmox advised her not to do so, because there were thousands.' }}
                            </h2>
                            <p class="lead">
                                {{ $pageContent['mission_lead'] ?? 'A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country.' }}
                            </p>
                            <p class="mb-5">
                                {{ $pageContent['mission_body'] ?? 'The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli.' }}
                            </p>
                            <p>
                                <a href="#" class="btn-get-started">{{ $pageContent['mission_button'] ?? 'Get Started' }}</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-4 ps-lg-5">
                    <span class="content-subtitle">{{ $pageContent['why_subtitle'] ?? 'Why Us' }}</span>
                    <h2 class="content-title">{{ $pageContent['why_title'] ?? 'Far far away Behind the Word Mountains' }}</h2>
                    <p class="lead">
                        {{ $pageContent['why_lead'] ?? 'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.' }}
                    </p>
                    <p class="mb-5">
                        {{ $pageContent['why_body'] ?? 'There live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.' }}
                    </p>
